...
const Navigation = () => {
  ...
  return (
    <>
      <header className="fixed top-0 w-full bg-[#2e2b29]">
        <div className="max-w-screen-2xl px-4 2xl:px-16 flex items-center justify-between transition-all duration-1000 ease-in-out mx-auto">
          <nav
