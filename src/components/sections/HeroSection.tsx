...
const HeroSection = () => {
  ...
  return (
    <>
      <MobileHeroSection />
      <section className="h-dynamic relative hidden w-full flex-col items-center justify-between border-b border-[#a286688e] bg-[url('/hero-frontpage.png')] bg-cover bg-center bg-no-repeat px-4 text-center lg:flex">
