...
const HeroSection = ({ title, description, image, showLogo }: Props) => {
  ...
  const imageBaseClasses =
    "h-full w-full object-cover object-bottom transition-all ease-in-out";
        ...
        <div className="relative h-full w-full max-w-screen-xl space-y-2 px-4 2xl:px-0">
          <div className="">
            ...
            <button
              ...
              className={twMerge(
                "mt-12 inline-block w-full rounded-sm bg-[#232323] py-2.5 text-center text-sm tracking-[0.2em] transition-all duration-200 ease-in-out hover:bg-brass hover:text-[#232323] sm:mt-16 sm:w-fit sm:px-12 sm:py-4 sm:text-base sm:text-brass",
                futuraStd.className,
              )}
            >
